...
<%
    ...
    tPaymentRequest.dicOrder.put("QRPayCode", request.getParameter("QRPayCode"));
    tPaymentRequest.dicOrder.put("Pid", request.getParameter("Pid"));
...
%>
<HTML>
<HEAD><TITLE>农行网上支付平台-商户接口范例-掌银被扫支付请求</TITLE></HEAD>

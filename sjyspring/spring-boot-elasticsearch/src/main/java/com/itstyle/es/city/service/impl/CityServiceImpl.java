...
public class CityServiceImpl implements CityService {
    ...
    @Override
    public void getNearbyCities(double lat, double lon) throws IOException {
        /**
        ...
        PointBuilder pointBuilder = new PointBuilder(lat, lon);
        QueryBuilder builder = QueryBuilders.geoDisjointQuery("location", pointBuilder);
        //字段精确匹配

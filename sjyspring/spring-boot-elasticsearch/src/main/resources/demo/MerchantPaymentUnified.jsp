...
<%
    ...
    tPaymentRequest.dicOrder.put("LimitPay", request.getParameter("LimitPay"));                     //限制贷记卡
...
//tPaymentRequest.dicRequest.put("ReceiveAccName", request.getParameter("ReceiveAccName"));      //设定收款方户名
    ...
    tPaymentRequest.dicRequest.put("IsBreakAccount", request.getParameter("IsBreakAccount"));      //设定交易是否支持向二级商户入账
    tPaymentRequest.dicRequest.put("MerModelFlag", request.getParameter("MerModelFlag"));          //是否为大商户模式
    tPaymentRequest.dicRequest.put("SubMerchantID", request.getParameter("SubMerchantID"));        //大商户模式的子商户号

    tPaymentRequest.dicRequest.put("CommodityType", request.getParameter("CommodityType"));           //设置商品种类

    tPaymentRequest.dicH5SceneInfo.put("H5SceneType", request.getParameter("H5SceneType"));        //场景类型
    tPaymentRequest.dicH5SceneInfo.put("H5SceneUrl", request.getParameter("H5SceneUrl"));          //场景URL
    tPaymentRequest.dicH5SceneInfo.put("H5SceneName", request.getParameter("H5SceneName"));        //场景名称
...
//JSON json = tPaymentRequest.extendPostRequest(1);
    ...
    if (ReturnCode.equals("0000")) {
        ...
        out.println("ThirdOrderNo  = [" + json.GetKeyValue("ThirdOrderNo") + "]<br/>");
        if (!QRURL.equals("") || paymentType.equals(Constants.PAY_TYPE_WX)) {
            out.println("QRURL = [" + json.GetKeyValue("QRURL") + "]<br/>");
        } else if (!APP.equals("")) {
            //out.println("APP = [" + json.GetKeyValue("APP")+ "]<br/>");
            out.println("appid = [" + json.GetKeyValue("appid") + "]<br/>");
            out.println("partnerid = [" + json.GetKeyValue("partnerid") + "]<br/>");
            out.println("prepayid = [" + json.GetKeyValue("prepayid") + "]<br/>");
            out.println("package = [" + json.GetKeyValue("package") + "]<br/>");
            out.println("noncestr = [" + json.GetKeyValue("noncestr") + "]<br/>");
            out.println("timestamp = [" + json.GetKeyValue("timestamp") + "]<br/>");
            out.println("sign = [" + json.GetKeyValue("sign") + "]<br/>");
        } else if (!JSAPI.equals("")) {
            //out.println("JSAPI = [" + json.GetKeyValue("JSAPI")+ "]<br/>");
            out.println("appid = [" + json.GetKeyValue("appid") + "]<br/>");
            out.println("timestamp = [" + json.GetKeyValue("timestamp") + "]<br/>");
            out.println("noncestr = [" + json.GetKeyValue("noncestr") + "]<br/>");
            out.println("package = [" + json.GetKeyValue("package") + "]<br/>");
            out.println("signType = [" + json.GetKeyValue("signType") + "]<br/>");
            out.println("paySign = [" + json.GetKeyValue("paySign") + "]<br/>");
        }
        //else {
        //out.println("ReturnCode   = [" + ReturnCode + "]<br/>");
        //out.println("ErrorMessage = [" + ErrorMessage + "]<br/>");

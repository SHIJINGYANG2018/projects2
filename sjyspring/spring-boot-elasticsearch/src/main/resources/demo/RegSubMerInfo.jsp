...
%>
<HTML>
<HEAD><TITLE>农行网上支付平台-商户接口范例-二级商户信息同步（新）</TITLE></HEAD>
<BODY BGCOLOR='#FFFFFF' TEXT='#000000' LINK='#0000FF' VLINK='#0000FF' ALINK='#FF0000'>
<CENTER>支付请求请求<br>
    <%
        //1、生成支付请求对象
        RegSubMerInfoRequest tMerchantInfo = new RegSubMerInfoRequest();
        ...
        tMerchantInfo.merchantInfoRequest.put("NotifyUrl", request.getParameter("txtNotifyUrl"));
        tMerchantInfo.merchantInfoRequest.put("Announce", request.getParameter("txtAnnounce"));
        tMerchantInfo.merchantInfoRequest.put("MerMobilePhone", request.getParameter("txtMerMobilePhoneNum"));

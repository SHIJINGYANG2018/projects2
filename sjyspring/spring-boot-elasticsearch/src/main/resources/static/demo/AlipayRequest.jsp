...
<%
    ...
    tPaymentRequest.dicOrder.put("PAYED_RETURN_URL", request.getParameter("PayedReturnUrl"));       //支付后回调地址
    ...
    tPaymentRequest.dicOrder.put("ChildMerchantNo", request.getParameter("ChildMerchantNo"));
    ; //子商户(大商户模式)
...
<%
    ...
    if (ReturnCode.equals("0000")) {
        ...
        if (!QRURL.equals("")) {
            ...
            out.println("ThirdReOrderNo = [" + json.GetKeyValue("ThirdReOrderNo") + "]<br/>");
        } else {

            out.println("ReturnCode   = [" + ReturnCode + "]<br/>");
            out.println("ErrorMessage = [" + ErrorMessage + "]<br/>");
            Base64 tBase64 = new Base64();
            String prePayId = new String(tBase64.decode(json.GetKeyValue("PrePayID")));
            out.println("PrePayID     = [" + prePayId + "]<br/>");
            out.println("ThirdOrderNo = [" + json.GetKeyValue("ThirdOrderNo") + "]<br/>");
            out.println("ThirdReOrderNo = [" + json.GetKeyValue("ThirdReOrderNo") + "]<br/>");
        }

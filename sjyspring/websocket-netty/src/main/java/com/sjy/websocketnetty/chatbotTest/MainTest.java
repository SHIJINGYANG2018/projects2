...
public class MainTest {
    public static void main(String[] args) throws Exception {
        ...
        System.out.println("输入url地址：");
        String url = sc.nextLine();  //读取字符串型输入
        System.out.println("输入手机号：");
        String mobile = sc.nextLine();
        System.out.println("输入contentType：");
        String contentTypeString = sc.nextLine();
        System.out.println("appSecret 密码：");
        String appSecret = sc.nextLine();
        appSecret =getSHA256(appSecret);
        System.out.println("appid ：");
        String appid = sc.nextLine();
        System.out.println("输入content编号：");
        int num = sc.nextInt();
        ...
        rcsSubmitMessage.setContentType(Integer.parseInt(contentTypeString));
        rcsSubmitMessage.setChatbotNumber(appid);
        String c = getContentXml(num);
        rcsSubmitMessage.setContent(c.substring(9,c.length()-3));
